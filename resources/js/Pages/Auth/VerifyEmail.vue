...
<template>
    ...
    <section class="">
        <form @submit.prevent="!form.processing && sendEmailVerification()" :class="['max-w-lg bg-white shadow-md py-6 px-4 rounded-md mx-auto space-y-6', { 'opacity-50':form.processing } ]">
